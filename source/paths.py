...
ERESMAP = (lambda filepath: PLTDIR(filepath).joinpath("map_resolution.png"))
CNTMAP = (lambda filepath: PLTDIR(filepath).joinpath("map_counts.png"))
SLOMAP = (lambda filepath: PLTDIR(filepath).joinpath("map_slo.png"))
