...
PFMTp20SLO = PFMTp20DIR.joinpath("report_slo.xlsx")
PFMTp10CAL = PFMTp10DIR.joinpath("report_cal.xlsx")
PFMTp10SLO = PFMTp10DIR.joinpath("report_slo.xlsx")
PFMTp00CAL = PFMTp00DIR.joinpath("report_cal.xlsx")
PFMTp00SLO = PFMTp00DIR.joinpath("report_slo.xlsx")
PFMTm10CAL = PFMTm10DIR.joinpath("report_cal.xlsx")
PFMTm10SLO = PFMTm10DIR.joinpath("report_slo.xlsx")
PFMTm20CAL = PFMTm20DIR.joinpath("report_cal.xlsx")
PFMTm20SLO = PFMTm20DIR.joinpath("report_slo.xlsx")
